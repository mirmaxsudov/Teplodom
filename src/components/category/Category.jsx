...
import "./Category.css"
const Category = () => {
    const { status, categories: data, isLoading } = useSelector(state => state.category)
...
const ShowCategories = ({ categories }) => {
    return <>
        <div className="pt-[50px]">
            ...
            <div className="flex flex-nowrap overflow-x-auto gap-[10px] items-stretch">
