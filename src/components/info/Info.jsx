            ...
            <div className="container mx-auto px-[30px] lg:px-[150px]">
                ...
                <div className="grid grid-rows-1 2xl:grid-cols-2 items-center gap-[30px] sm:gap-[57px]">
                    <p className='text-[16px] sm:text-[18px] text-center md:text-start'>
                        Компания <b className='font-bold'>Teplodom</b> является лидером строительных материалов на локальном рынке и предлагает широкий ассортимент строительных, отделочных материалов и товаров для дома всем клиентам Узбекистана.
